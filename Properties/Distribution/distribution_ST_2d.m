...
% %% Distribution
% % We want to plot the histogram of the vqlue of the coefficient for each
% % layer, orientation and scale
% 
% % Path to the ST
% trail = {};
% 
...
%             hist(reshape(S{n}.signal{trail{n}(i)},numel(S{n}.signal{trail{n}(i)}),1))
% 
