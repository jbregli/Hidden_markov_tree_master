...
%                     % Ignore already converged/bugy updates:
%                     theta{layer}.epsilon{scale} = ...
%                         not(check_strct{layer}.epsilon{scale}) .* ...
%                             permute(tmp_epsilon,[3 4 1 2]) ...
%                         + check_strct{layer}.epsilon{scale} .* ...
%                             theta_old{layer}.epsilon{scale};
                else
...
% %                             theta_old{layer}.epsilon{scale};
                ...
                theta{layer}.mu{scale} = ...                                        
                        not(check_strct{layer}{scale}) .* tmp_mu ...
                        + check_strct{layer}{scale} .* ...
                            theta_old{layer}.mu{scale};
                % Sigma:
                theta{layer}.sigma{scale} = ...                                        
                        not(check_strct{layer}{scale}) .* tmp_sigma ...
                        + check_strct{layer}{scale} .* ...
                            theta_old{layer}.sigma{scale};
                        
%                 % Mu:  ---    CV_CHECK VERSION
%                 theta{layer}.mu{scale} = ...                                        
%                         not(check_strct{layer}.mu{scale}) .* tmp_mu ...
%                         + check_strct{layer}.mu{scale} .* ...
%                             theta_old{layer}.mu{scale};
%                 % Sigma:
%                 theta{layer}.sigma{scale} = ...                                        
%                         not(check_strct{layer}.sigma{scale}) .* tmp_sigma ...
%                         + check_strct{layer}.sigma{scale} .* ...
%                             theta_old{layer}.sigma{scale};
            end

            % Proba:
            theta{layer}.proba{scale} =  ...                                        
                        not(check_strct{layer}{scale}) .* tmp_proba ...
                        + check_strct{layer}{scale} .* ...
                            theta_old{layer}.proba{scale};            
            
%             % Proba:  ---    CV_CHECK VERSION
%             theta{layer}.proba{scale} =  ...                                        
%                         not(check_strct{layer}.proba{scale}) .* tmp_proba ...
%                         + check_strct{layer}.proba{scale} .* ...
%                             theta_old{layer}.proba{scale};
