        ...
        for scale=1:n_scale(1,layer)
            ...
            if layer > 1
                ...
                theta{layer}.mu{scale} = ...                                        
                        not(mask{layer}.mu{scale}) .* tmp_mu ...
                        + mask{layer}.mu{scale} .* ...
                            theta_old{layer}.mu{scale};
                % Sigma:
                theta{layer}.sigma{scale} = ...                                        
                        not(mask{layer}.sigma{scale}) .* tmp_sigma ...
                        + mask{layer}.sigma{scale} .* ...
                            theta_old{layer}.sigma{scale};
            end

            % Proba:
            theta{layer}.proba{scale} =  ...                                        
                        not(mask{layer}.proba{scale}) .* tmp_proba ...
                        + mask{layer}.proba{scale} .* ...
