...
% Data path:
im_format = 'png';
dir_data = '/home/jeanbaptiste/Datasets/Texture/Kylberg/WO_Rota/';

% Labels available:
% aluminium_foil , brown_bread , corduroy , cotton , cracker , linen , 
% orange_peel , sandpaper , sponge , styrofoam
S_label = {'blanket1', 'blanket2', 'canvas1', 'ceiling1', 'ceiling2',...
    'cushion1', 'floor1', 'floor2', 'grass1', 'lentils1', 'linseeds1',...
    'oatmeal1', 'pearlsugar1', 'rice1', 'rice2', 'rug1', 'sand1', ...
    'scarf1', 'scarf2', 'screen1', 'seat1', 'seat2', 'sesameseeds1', ...
    'stone1', 'stone2', 'stone3', 'stoneslab1', 'wall1'}; 
